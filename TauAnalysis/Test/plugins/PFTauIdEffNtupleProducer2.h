...
class PFTauIdEffNtupleProducer2 : public edm::EDProducer 
{
 ...
 private:
  ...
  void setGenTauMatchValues(bool, const reco::Candidate::LorentzVector& = reco::Candidate::LorentzVector(0.,0.,0.,0.), int = -1, double = 9.9, const reco::Candidate::LorentzVector& = reco::Candidate::LorentzVector(0.,0.,0.,0.));
  void setGenTauExtraValues(int genTauLchMother=0, float genTauLchPhPt=0, int genTauNDaughters=0, int genTauNDaPhotons=0);
