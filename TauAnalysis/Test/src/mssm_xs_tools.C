...
void mssm_xs_tools::SetInput(const char* filename){
...
Double_t mssm_xs_tools::Give_XsecUnc_muup_ggFA(Double_t mA, Double_t tanb){ //muup=scale0.5
...
Double_t mssm_xs_tools::Give_XsecUnc_muup_ggFH(Double_t mA, Double_t tanb){ //muup=scale0.5
...
Double_t mssm_xs_tools::Give_XsecUnc_mudown_ggFA(Double_t mA, Double_t tanb){ //mudown=scale2.0
...
Double_t mssm_xs_tools::Give_XsecUnc_mudown_ggFH(Double_t mA, Double_t tanb){ //mudown=scale2.0
